...
if not os.path.exists(working_dir + "/coefficient.xlsx"):
	...
	for i in range(0,16):
		if(i<4):
			...
			pos1 = str(chr(65+i-3)) + "3"
			pos2 = str(chr(65+i-3)) + "12"
		elif(i<12):
			pos1 = str(chr(65+i-7)) + "4"
			pos2 = str(chr(65+i-7)) + "13"
		else:
			pos1 = str(chr(65+i-11)) + "5"
			pos2 = str(chr(65+i-11)) + "14"
...
coefficient = list(range(16))
base_intensity = list(range(16))
...
for i in range(0,16):
	if(i<4):
		...
		pos = str(chr(65+i-3)) + "3"
		pos1 = str(chr(65+i-3)) + "12"
	elif(i<12):
		pos = str(chr(65+i-7)) + "4"
		pos1 = str(chr(65+i-7)) + "13"
	else:
	...
	def process(self, coefficient, mode=0, well_list=[]):
		...
		if(mode==0):
			try:
				...
				bounding_rect_15 = cv2.boundingRect(contours[len(contours)-1])
				new_start_point = (bounding_rect_0[0]-8, bounding_rect_0[1]-8)
				new_end_point = (bounding_rect_15[0]+bounding_rect_15[2]+8, bounding_rect_15[1]+bounding_rect_15[3]+8)
		...
		cell_w = round(rect_w/4)
		cell_h = round(rect_h/4)
		for i in range(1,4):
		...
		list_intensities = []
		sum_intensities = []
		result_list = list(range(16))
		area = list(range(16))

		blur1_img = cv2.GaussianBlur(self.image.copy(), (25,25), 0)
		tmp_list = list(range(16))
		list_bgrvalue = []
		list_index = list(range(16))
...
class QualitativeAnalysisFrame3(Frame):
	...
	def serial_handle(self):
		...
		if(bled_ready):
			...
			self.result_label = list(range(16))
			r=0
			c=-1
...
class IDCreateFrame(Frame):
	...
	def create_clicked(self):
		...
		if(msg=="yes"):
			self.well_button_change_pos = list(range(16))
			wb = Workbook()
			sheet = wb.active
			...
			if(file_create_done):
				if(self.direct_create == 0): #create file with create module from main menu
					...
					self.base_window.qualitative_analysis_2.id_label = list(range(16))
					r=0
					c=-1
					for i in range(0,16):
						c+=1
